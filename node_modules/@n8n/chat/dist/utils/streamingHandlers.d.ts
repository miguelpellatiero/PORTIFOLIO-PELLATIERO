import { Ref } from 'vue';
import { ChatMessage, ChatMessageText, ChatOptions } from '../types';
...
export declare function handleNodeComplete(nodeId: string, streamingManager: StreamingMessageManager, runIndex: number | undefined, userMessage: string, options: ChatOptions, messages: Ref<ChatMessage[]>): Promise<boolean>;
